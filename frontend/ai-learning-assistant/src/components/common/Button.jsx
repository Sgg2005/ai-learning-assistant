...
const Button = ({
    ...
    const variantStyles = {
        primary: 'bg-gradient-to-br from-orange-400 to-orange-500 text-white shadow-lg shadow-orange-500/25 hover:scale-[1.02] hover:shadow-xl',
        secondary: 'bg-slate-100 text-slate-700 hover:bg-slate-200',
        outline: 'bg-white border-2 border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-slate-300',
        danger: 'bg-red-500 text-white shadow-lg shadow-red-500/25 hover:bg-red-600 hover:shadow-xl',
    };
