  ...
  return (
    <div className="w-full h-64" style={{ perspective: "1000px" }}>
      ...
      >
        {/* Front Side */}
        <div
          className="absolute inset-0 bg-white dark:bg-slate-800 border border-orange-100 dark:border-slate-700 rounded-2xl p-5 flex flex-col justify-between shadow-sm"
          style={{
        ...
        {/* Back Side */}
        <div
          className="absolute inset-0 bg-orange-50 dark:bg-orange-500/10 border border-orange-100 dark:border-orange-500/20 rounded-2xl p-5 flex flex-col justify-between shadow-sm"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",
