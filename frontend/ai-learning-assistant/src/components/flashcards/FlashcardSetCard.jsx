...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  return (
    <div
      className="bg-white border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-6 cursor-pointer hover:shadow-2xl hover:scale-[1.01] transition-all duration-200"
